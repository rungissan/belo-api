...
// const DIST_INDEX = join(process.cwd(), 'browser', 'index.html');
var BROWSER_FOLDER = path_1.join(process.cwd(), 'dist', 'browser');
var DIST_INDEX = path_1.join(process.cwd(), 'dist', 'browser', 'index.html');
console.log(BROWSER_FOLDER);
console.log(DIST_INDEX);
// Load the index.html file containing referances to your application bundle.
var index = fs_1.readFileSync(DIST_INDEX, 'utf8');
var win = domino_1.createWindow(index.toString());
global['window'] = win;
